 ...
 * @author adity
 */
public class SystemViewEncounter extends javax.swing.JFrame {

    /**
     * Creates new form SystemViewDoctor
     */
    public SystemViewEncounter() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Encounter Information");

        jLabel2.setText("Search By Encounter ID: ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Name", "Mobile No", "EmailID", "Age", "Gender", "Height", "EmailID"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SystemViewEncounter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SystemViewEncounter().setVisible(true);
            }
        });
    }
