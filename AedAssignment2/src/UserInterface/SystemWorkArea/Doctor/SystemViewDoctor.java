 ...
 * @author adity
 */
public class SystemViewDoctor extends javax.swing.JFrame {

    /**
     * Creates new form SystemViewDoctor
     */
    public SystemViewDoctor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SystemViewDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SystemViewDoctor().setVisible(true);
            }
        });
    }
