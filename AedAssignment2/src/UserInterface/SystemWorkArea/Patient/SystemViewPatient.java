 ...
 * @author adity
 */
public class SystemViewPatient extends javax.swing.JFrame {

    /**
     * Creates new form SystemViewDoctor
     */
    public SystemViewPatient() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Search Doctor By Hospital Name: ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SystemViewPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SystemViewPatient().setVisible(true);
            }
        });
    }
